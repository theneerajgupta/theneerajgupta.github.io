            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li><button onClick={() => navigate("blog")}>Notes</button></li>
                        <li><button onClick={() => navigate("blog")}>Case Studies</button></li>
                        <li><button onClick={() => navigate("blog")}>Projects</button></li>
                        <li><button onClick={() => navigate("blog")}>Blog</button></li>
                    </ul>
                </div>
                <a className="btn btn-ghost text-xl" onClick={() => navigate("/")}>theneerajgupta.github.io</a>
            </div>
